        ...
        for iii in range(68):
            ...
            for i in range(self.N):
                ...
                for j in range(self.N):
                    self.A[i, j] = numeratorA / denominatorA
                    numeratorA = 0.0

                for k in range(self.M):
                    self.B[i, k] = numeratorB / denominatorB
                    numeratorB = 0.0

                pi[i] = denominatorA = denominatorB = 1;
            print self.A
            print self.B
            print "Pi:",self.pi
            print probf
...
if __name__ == "__main__":
    ...
    # priors_file.close()
    priors_info = {}
    hdfs_address = 'hdfs://cats/user/pyj/newbkt/'
    observations_path="10000_10.txt"
